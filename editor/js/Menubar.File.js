...
Menubar.File = function ( editor ) {
	...
	option.onClick( function () {
		...
		if ( vr ) {
			...
			loader.load( 'threeexamples/js/controls/VRControls.js', function ( content ) {

				zip.file( 'js/VRControls.js', content );

			} );

			loader.load( 'threeexamples/js/effects/VREffect.js', function ( content ) {

				zip.file( 'js/VREffect.js', content );

			} );

			loader.load( 'threeexamples/js/WebVR.js', function ( content ) {
